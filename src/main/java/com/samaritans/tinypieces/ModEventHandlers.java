...
public class ModEventHandlers {
    ...
    public static void shulkerSpawn(WorldEvent.PotentialSpawns event) {
        if (event.getWorld().getDimension().getType() == DimensionType.THE_END && Feature.END_CITY.isPositionInsideStructure(event.getWorld(), event.getPos())) {
    ...
    public static void rabbitSpawn(WorldEvent.PotentialSpawns event) {
        if (BiomeDictionary.hasType(event.getWorld().getBiome(event.getPos()), BiomeDictionary.Type.FOREST)) {
