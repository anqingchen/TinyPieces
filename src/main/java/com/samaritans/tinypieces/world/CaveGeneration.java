    ...
    public static void setupCaveGen() {
        for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
            if (Config.mossy_forest && BiomeDictionary.hasType(biome, BiomeDictionary.Type.FOREST)) {
                biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, ModFeature.CAVE_WALL.get()
                        .configure(new ReplaceBlockConfig(Blocks.MOSSY_COBBLESTONE.getDefaultState(), Config.mossy_stone ? ModBlocks.mossy_stone.get().getDefaultState() : Blocks.MOSSY_COBBLESTONE.getDefaultState()))
            ...
            if (Config.mossy_jungle && BiomeDictionary.hasType(biome, BiomeDictionary.Type.JUNGLE)) {
                biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, ModFeature.CAVE_VINES.get()
            ...
            if (Config.icy_snow && BiomeDictionary.hasType(biome, BiomeDictionary.Type.SNOWY)) {
                ...
                biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, ModFeature.ICE_GLAZE_FLOOR.get()
                        .configure(IFeatureConfig.NO_FEATURE_CONFIG)
            ...
            if (Config.wet_ocean && BiomeDictionary.hasType(biome, BiomeDictionary.Type.OCEAN)) {
                biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, ModFeature.WATER_PUDDLE_FLOOR.get()
                        .configure(IFeatureConfig.NO_FEATURE_CONFIG)
                ...
                biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, ModFeature.CAVE_DEAD_CORAL.get()
                        .configure(IFeatureConfig.NO_FEATURE_CONFIG)
