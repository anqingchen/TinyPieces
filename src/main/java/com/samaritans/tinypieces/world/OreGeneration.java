        ...
        for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
            ...
            if (biome.getCategory() == Biome.Category.NETHER) {
                ...
                if (Config.nether_gold_ore) {
                    GenerationHelper.addOreGentoBiome(biome, OreFeatureConfig.FillerBlockType.NETHERRACK, ModBlocks.nether_gold_ore.get().getDefaultState(),
                ...
                if (Config.quartz_ore) {
                    GenerationHelper.addOreGentoBiome(biome, OreFeatureConfig.FillerBlockType.NATURAL_STONE, ModBlocks.quartz_ore.get().getDefaultState(),
